...
- Dark mode background not visible in dark mode - [Issue](https://github.com/nesaku/SpotifyInfo/issues/5)

## [6.0.0] - Apr 17, 2026

### Changed

- Use scraping (again) for data
- Rewrite and clean up code
- Update default user agent

### Fixed

- Fix pages not working

## [5.0.1] - Jan 19, 2026

### Fixed

- Fix the audio previews not working

## [5.0.0] - Jan 19, 2026

### Changed

- Use the official Spotify Web API for data

## [4.2.1] - Oct 18, 2025

### Changed

- Change the latest TOTP secret endpoint
