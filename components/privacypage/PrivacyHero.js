    ...
    <div>
      <div className="mx-auto max-w-screen-xl px-4 py-20 lg:flex lg:mt-20">
        <div className="mx-auto max-w-3xl text-center text-gray-900 dark:text-white ">
          <h1 className="bg-gradient-to-r from-green-600 to-green-600 bg-clip-text text-4xl font-extrabold text-transparent sm:text-7xl p-2 capitalize">
            Privacy Policy
          </h1>
          <div className="text-left mt-10">
            ...
            <p className="mx-auto text-lg mt-12">
              SpotifyInfo legal basis for collecting and using the personal
            ...
            <ul className="list-disc ml-20 mt-8">
              <li>SpotifyInfo needs to perform a contract with you</li>
              <li>You have given SpotifyInfo permission to do so</li>
              <li>
                Processing your personal information is in SpotifyInfo
                legitimate interests
              </li>
              <li>SpotifyInfo needs to comply with the law</li>
            </ul>

            <p className="mx-auto text-lg mt-12">
              SpotifyInfo will retain your personal information only for as long
            ...
            <p className="mx-auto text-lg mt-12">
              SpotifyInfo&apos;s Privacy Policy does not apply to other
            ...
            <p className="mx-auto text-lg mt-12">
              SpotifyInfo does not knowingly collect any Personal Identifiable
